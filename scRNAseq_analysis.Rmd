...
inps <- base::readRDS(
  file = base::list.files(
    ...
    stringr::str_subset("*inps*")
  )
```

## [2.11.] Read out markers for all clusters
#### default test used is "wilcoxon"
```{r}
...
## [2.13.] Save, load & write clusStats
```{r}
base::saveRDS(
  object = clusStats,
  file = base::paste0(
...
## [3.0.] Read in 'mergeTF'
#### see [2.10.]-[2.11.] in 'annotate_peaks.Rmd'
```{r}
...
## [8.0.] Load sortTF
#### see [2.6.], [2.8.] 'annotate_peaks.Rmd'
```{r}
sortTF <- base::readRDS(
  file = base::list.files(
        here::here("data"),
